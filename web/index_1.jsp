        ...
        <!--<form action="ProceedToCheckout" method="post">-->
            <div class="cart-total">
                ...
                <div class="box">
                    ...
                    <button class="btn" id="myBtn">proceed to checkout</button>
                    <!-- The Modal -->
...
<section class="popular" id="popular">
    ...
    <div class="box-container">
        ...
        <form action="AddToCart" method="post">
            ...
            <div class="content">
                <h3> <input type="hidden" name="name" value="Momo's at your plate"> Momo's at your plate</h3>
                ...
                <div class="price" ><input type="hidden" name="price" value="$40.00">$40.00 <span>$50.00</span></div>
         ...
         <form action="AddToCart" method="post">
            ...
            <div class="content">
                <h3> <input type="hidden" name="name" value="Burger">Burger</h3>
                <input type="hidden" name="quantity" value="1">
                ...
                <div class="price"><input type="hidden" name="price" value="$60.00">$60.00 <span>$70.00</span></div>
                <button class="btn">add to cart</button>
            </div>
        </div>
        </form>
        ...
        <form action="AddToCart" method="post">
            ...
            <div class="content">
                ...
                <div class="price"><input type="hidden" name="price" value="$20.00">$20.00 <span>$30.00</span></div>
                <button class="btn">add to cart</button>
            </div>
        </div>
        ...
        <form action="AddToCart" method="post">
            ...
            <div class="content">
                <h3><input type="hidden" name="name" value="Tandoori burger">Tandoori burger</h3>
                <input type="hidden" name="quantity" value="1">
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <div class="price"><input type="hidden" name="price" value="$35.00">$35.00 <span>$42.00</span></div>
               <button class="btn">add to cart</button>
            </div>
        </div>
        </form>
        ...
        <form action="AddToCart" method="post">
            ...
            <div class="content">
                <h3><input type="hidden" name="name" value="King Pizza">King Pizza</h3>
                <input type="hidden" name="quantity" value="1">
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <div class="price"><input type="hidden" name="price" value="$30.00">$30.00 <span>$50.00</span></div>
               <button class="btn">add to cart</button>
            </div>
        </div>
        ...
        <form action="AddToCart" method="post">
            ...
            <div class="content">
                <h3><input type="hidden" name="name" value="capsicum pizza">capsicum pizza</h3>
                <input type="hidden" name="quantity" value="1">
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
        ...
        <form action="AddToCart" method="post">
            ...
            <div class="content">
                <h3><input type="hidden" name="name" value="double petty burger">double petty burger</h3>
                <input type="hidden" name="quantity" value="1">
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <div class="price"><input type="hidden" name="price" value="$45.00">$45.00 <span>$50.00</span></div>
                <button class="btn">add to cart</button>
            </div>
        </div>
        </form>
        ...
        <form action="AddToCart" method="post">
            ...
            <div class="content">
                <h3><input type="hidden" name="name" value="today's special">today's special</h3>
                <input type="hidden" name="quantity" value="1">
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
...
<section class="order" id="order">
    ...
    <form action="OrderServlet" method="post">
        ...
        <div class="flex">
            <div class="inputBox">
                <span>your name</span>
                <input type="text" placeholder="customer's name" name="name" id="">
            </div>
            <div class="inputBox">
                <span>your number</span>
                <input type="number" placeholder="customer's number" name="number" id="" required>
            </div>
        </div>
        ...
        <div class="flex">
            <div class="inputBox">
                ...
                <input type="text" placeholder="food you want" name="food" id="" required>
            </div>
            <div class="inputBox">
                <span>how much</span>
                <input type="number" placeholder="number or orders" name="order" id="">
            </div>
        </div>
        ...
        <div class="flex">
            <div class="inputBox">
                ...
                <input type="text" placeholder="your message" name="message" id="">
            </div>
            <div class="inputBox">
